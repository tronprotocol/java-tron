...
public class Storage {
  ...
  public static final List<String> CACHE_SMALL_DBS = Arrays.asList("recent-block", "witness",
  ...
  public static final List<String> CACHE_NORMAL_DBS = Arrays.asList("code", "contract",
      "asset-issue-v2");
  ...
  public static final List<String> CACHE_HUGE_DBS = Arrays.asList("storage-row", "account");

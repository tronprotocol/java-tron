...
public class TrafficStats {
  ...
  static class TrafficStatHandler extends ChannelDuplexHandler {
    @Getter private AtomicLong outSize = new AtomicLong();
    @Getter private AtomicLong inSize = new AtomicLong();
    @Getter private AtomicLong outPackets = new AtomicLong();
    @Getter private AtomicLong inPackets = new AtomicLong();

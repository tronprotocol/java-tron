...
public class HttpShieldTrc20Token003 extends ZenTrc20Base {
  ...
  private Long account2Receive2V2Amount = publicFromAmount + account2Receive1V2Amount - account1Receive2V2Amount;
  ...
  public void prepareForTransfer() {
    ...
    shieldedReceives = getHttpShieldedReceivesJsonArray(shieldedReceives,publicFromAmount,shieldAccountInfo1.getString("payment_address"),getRcm(httpnode));
    ...
    response = createShieldContractParameters(httpnode,publicFromAmount,shieldAccountInfo2,shieldedReceives);
    responseContent = HttpMethed.parseResponseContent(response);
    //HttpMethed.printJsonContent(responseContent);
  ...
  public void test01TransferTypeWith1V1ByHttp() {
    ...
    //shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account1IvkNoteTxs.getJSONObject(2));
    shieldedReceives.clear();
    shieldedReceives = getHttpShieldedReceivesJsonArray(shieldedReceives,publicFromAmount * 2,shieldAccountInfo2.getString("payment_address"),getRcm(httpnode));
    shieldedReceives = getHttpShieldedReceivesJsonArray(shieldedReceives,0L,shieldAccountInfo2.getString("payment_address"),getRcm(httpnode));
  ...
  public void test02TransferTypeWith1V2ByHttp() {
    ...
    Assert.assertFalse(isShieldedTrc20ContractNoteSpent(httpnode,shieldAccountInfo1,account1IvkNoteTxs.getJSONObject(1)));
    shieldSpends.clear();
    shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account1IvkNoteTxs.getJSONObject(1));
    ...
    shieldSpends.clear();
    shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account2IvkNoteTxs.getJSONObject(1));

    shieldedReceives.clear();
    shieldedReceives = getHttpShieldedReceivesJsonArray(shieldedReceives,0L,shieldAccountInfo1.getString("payment_address"),getRcm(httpnode));
...
/*    account1OvkNoteTxs = scanShieldTrc20NoteByOvk(httpnode,shieldAccountInfo1);
  ...
  public void test03TransferTypeWith2V2ByHttp() {
    ...
    Assert.assertFalse(isShieldedTrc20ContractNoteSpent(httpnode,shieldAccountInfo2,account2IvkNoteTxs.getJSONObject(1)));
    shieldSpends.clear();
    shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account2IvkNoteTxs.getJSONObject(0));
    shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account2IvkNoteTxs.getJSONObject(1));
    shieldedReceives.clear();
    ...
    Assert.assertTrue(isShieldedTrc20ContractNoteSpent(httpnode,shieldAccountInfo2,account2IvkNoteTxs.getJSONObject(0)));
    Assert.assertTrue(isShieldedTrc20ContractNoteSpent(httpnode,shieldAccountInfo2,account2IvkNoteTxs.getJSONObject(1)));
  ...
  public void test04TransferTypeWith2V1ByHttp() {
    ...
    Assert.assertFalse(isShieldedTrc20ContractNoteSpent(httpnode,shieldAccountInfo1,account1IvkNoteTxs.getJSONObject(3)));
    shieldSpends.clear();
    shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account1IvkNoteTxs.getJSONObject(2));
    shieldSpends = createAndSetShieldedSpends(httpnode,shieldSpends,account1IvkNoteTxs.getJSONObject(3));
    Long account1Receive2V1Amount = account1IvkNoteTxs.getJSONObject(2).getJSONObject("note").getLong("value")

...
public class TRC10Test extends VMContractTestBase {
  ...
  public void testTRC10Validate() throws ContractExeException,
    ...
    String abi = "[{\"constant\":false,"
            ...
            + "\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]";
    String factoryCode = "608060405234801561001057600080fd5b50d3801561001d57600080fd5"
            + "b50d2801561002a57600080fd5b506102938061003a6000396000f3fe6080604052348"
            + "01561001057600080fd5b50d3801561001d57600080fd5b50d2801561002a57600080f"
            + "d5b50600436106100505760003560e01c80633615673e14610055578063f177bc7a146"
            + "100c2575b600080fd5b6100ac6004803603608081101561006b57600080fd5b8101908"
            + "08035906020019092919080359060200190929190803567ffffffffffffffff1690602"
            + "00190929190803560ff16906020019092919050505061021e565b60405180828152602"
            + "00191505060405180910390f35b61021c600480360360608110156100d857600080fd5"
            ...
            + "0200160405190810160405280939291908181526020018383808284376000818401526"
            + "01f19601f8201169050808301925050505050505091929192908035906020019064010"
    ...
    String hexInput = AbiUtil.parseMethod(methodTokenIssue,
            Arrays.asList(tokenP1, tokenP2, tokenP3, tokenP4));
    ...
    hexInput = AbiUtil.parseMethod(methodTokenIssue,
            Arrays.asList(tokenP1, tokenP2, tokenP3, tokenP4));
    ...
    result = TvmTestUtils.triggerContractAndReturnTvmTestResult(Hex.decode(OWNER_ADDRESS),
            ...
            Hex.decode(hexInput), value, fee, manager, null);
    Assert.assertNull(result.getRuntime().getRuntimeError());
    Assert.assertEquals(ByteArray.toStr(manager.getAssetIssueV2Store()
                    .getAllAssetIssues().get(0).getUrl().toByteArray()),
            "abc");
    Assert.assertEquals(ByteArray.toStr(manager.getAssetIssueV2Store()
                    .getAllAssetIssues().get(0).getDesc().toByteArray()),
            "abc");
    // validate energy cost
    ...
    updateP1 = 1000001;
    updateP2 = "abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabca"
            + "bcabcabcabcabcabcabcabcabcabcabcabcabcababcabcabcabcabcabcabca"
    ...
    updateP1 = 1000001;
    updateP3 = "abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabc"
            + "abcabcabcabcabcabcabcabcabcabcabcabcaabcabcabcabcabcabcabcabcabc"
            + "abcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabca"
            + "bcabcabcaabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabcabca"
            + "bcabcabcabcabcabcabcabcabcabcabcabcabcabcabcaabcabcabcabcabcabca"
  ...
  public void testTRC10ForMultiCall() throws ContractExeException,
    ...
    String abi = "[{\"constant\":false,\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"name\","
            ...
            + "name\":\"TokenIssue\",\"outputs\":[],\"payable\":false,\"stateMutability\":\""
            + "nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType"
            + "\":\"trcToken\",\"name\":\"tokenId\",\"type\":\"trcToken\"},{\"internalType\":\""
            + "string\",\"name\":\"desc\",\"type\":\"string\"},{\"internalType\":\"string\",\""
            + "name\":\"url\",\"type\":\"string\"}],\"name\":\"UpdateAsset\",\"outputs\":[],\""
            + "payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]";
    String factoryCode = "608060405234801561001057600080fd5b50d3801561001d57600080fd5b5"
            ...
            + "0fd5b6100ac6004803603608081101561006b57600080fd5b8101908080359060200190929"
            + "19080359060200190929190803567ffffffffffffffff169060200190929190803560ff169"
            + "06020019092919050505061020a565b005b610208600480360360608110156100c45760008"
            + "0fd5b8101908080359060200190929190803590602001906401000000008111156100eb576"
            + "00080fd5b8201836020820111156100fd57600080fd5b80359060200191846001830284011"
            ...
            + "2840111640100000000831117156101b657600080fd5b91908080601f01602080910402602"
            + "0016040519081016040528093929190818152602001838380828437600081840152601f196"
            + "01f82011690508083019250505050505050919291929050505061021c565b005b80828486d"
            + "a5080828486da5050505050565b808284db50808284db5050505056fea26474726f6e58201"
            + "0b72c10cc2d93a0ddc6ec14e8a40345f73a2263120bd04e1552687570eb950c64736f6c637"
            + "828302e352e31332d646576656c6f702e323032302e382e31332b636f6d6d69742e3763323"
            + "6393863300057";
    long value = 0;
    long fee = 100000000;
    long consumeUserResourcePercent = 0;
    ...
    String updateP3 = updateP2;
    String hexInput = AbiUtil.parseMethod(methodUpdateAsset,
  ...
  contract HelloWorld{
      ...
      function TokenIssue(bytes32 name, bytes32 abbr, uint64 totalSupply,
        uint8 precision, address addr) public {
          address payable newaddress = address(uint160(addr));
          newaddress.transfer(100000000);
          assetissue(name, abbr, totalSupply, precision);
          newaddress.transfer(100000000);
      }
      function UpdateAsset(trcToken tokenId, string memory desc,
        string memory url, address addr) public {
          address payable newaddress = address(uint160(addr));
          newaddress.transfer(100000000);
          updateasset(tokenId, bytes(desc), bytes(url));
          newaddress.transfer(100000000);
  ...
  public void testTRC10Exception() throws ContractExeException,
    ...
    String abi = "[{\"constant\":false,\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"name\","
            ...
            + "{\"internalType\":\"uint64\",\"name\":\"totalSupply\",\"type\":\"uint64\"},"
            + "{\"internalType\":\"uint8\",\"name\":\"precision\",\"type\":\"uint8\"},"
            + "{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\""
            + "address\"}],\"name\":\"TokenIssue\",\"outputs\":[],\"payable\":"
            + "false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},"
            + "{\"constant\":false,\"inputs\":[{\"internalType\":\"trcToken\",\""
            + "name\":\"tokenId\",\"type\":\"trcToken\"},{\"internalType\":\"string\",\""
            + "name\":\"desc\",\"type\":\"string\"},"
            + "{\"internalType\":\"string\",\"name\":\"url\",\"type\":\"string\"},{\""
            + "internalType\":\"address\","
            + "\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"UpdateAsset\","
            + "\"outputs\":[],\"payable\":false,"
            + "\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]";
    String factoryCode = "608060405234801561001057600080fd5b50d3801561001d57600080fd5b50d2"
            + "801561002a57600080fd5b506103f48061003a6000396000f3fe60806040523480156100105"
            + "7600080fd5b50d3801561001d57600080fd5b50d2801561002a57600080fd5b506004361061"
            + "00505760003560e01c8063451ecfa214610055578063a241e431146100ce575b600080fd5b6"
            + "100cc600480360360a081101561006b57600080fd5b81019080803590602001909291908035"
            + "9060200190929190803567ffffffffffffffff169060200190929190803560ff16906020019"
            + "0929190803573ffffffffffffffffffffffffffffffffffffffff1690602001909291905050"
            ...
            + "01111561011d57600080fd5b803590602001918460018302840111640100000000831117156"
            + "1013f57600080fd5b91908080601f0160208091040260200160405190810160405280939291"
            ...
            + "56101d657600080fd5b91908080601f01602080910402602001604051908101604052809392"
            + "9190818152602001838380828437600081840152601f19601f8201169050808301925050505"
            ...
            + "fffff166108fc6305f5e1009081150290604051600060405180830381858888f19350505050"
            + "158015610299573d6000803e3d6000fd5b5082848688da508073fffffffffffffffffffffff"
            + "fffffffffffffffff166108fc6305f5e1009081150290604051600060405180830381858888"
            + "f193505050501580156102ea573d6000803e3d6000fd5b50505050505050565b60008190508"
            + "073ffffffffffffffffffffffffffffffffffffffff166108fc6305f5e10090811502906040"
            + "51600060405180830381858888f19350505050158015610342573d6000803e3d6000fd5b508"
            + "28486db508073ffffffffffffffffffffffffffffffffffffffff166108fc6305f5e1009081"
            + "150290604051600060405180830381858888f19350505050158015610392573d6000803e3d6"
            + "000fd5b50505050505056fea26474726f6e5820e6e64fe3d21e1866d8b2da9e9bba20e7b5fe"
            + "e47cf6122aae388eb63b4d3df07264736f6c637828302e352e31332d646576656c6f702e323"
            + "032302e382e31332b636f6d6d69742e37633236393863300057";
    long value = 0;
    long fee = 100000000;
    long consumeUserResourcePercent = 0;
    // deploy contract
    ...
    String hexInput = AbiUtil.parseMethod(methodTokenIssue,
            Arrays.asList(tokenP1, tokenP2, tokenP3, tokenP4, receiveAddress));
    TVMTestResult result = TvmTestUtils
            .triggerContractAndReturnTvmTestResult(Hex.decode(OWNER_ADDRESS),
            factoryAddress,
            Hex.decode(hexInput), value, fee, manager, null);
    ...
    Assert.assertEquals(200000000,
            rootRepository.getBalance(PublicMethed.decode58Check(receiveAddress)));
  ...
  contract A {
      ...
      function TokenIssueA(bytes32 name, bytes32 abbr,
        uint64 totalSupply, uint8 precision) public returns (uint){
          return assetissue(name, abbr, totalSupply, precision);
      }

      function UpdateAssetA(trcToken tokenId, string memory desc,
  ...
  contract HelloWorld {
      ...
      A a = new A();
      function TokenIssue(bytes32 name, bytes32 abbr, uint64 totalSupply,
        uint8 precision) public returns (uint) {
  ...
  public void testTRC10ContractCall() throws ContractExeException,
    ...
    String abi = "[{\"constant\":false,\"inputs\":[{\"internalType\":\"bytes32\","
            ...
            + "{\"internalType\":\"uint64\",\"name\":\"totalSupply\",\"type\":\"uint64\"},"
            + "{\"internalType\":\"uint8\",\"name\":\"precision\",\"type\":\"uint8\"}],"
            + "\"name\":\"TokenIssue\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":"
            + "\"\",\"type\":\"uint256\"}],\"payable\":false,"
            + "\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,"
            + "\"inputs\":[{\"internalType\":\"trcToken\",\"name\":\"tokenId\",\"type\""
            + ":\"trcToken\"}, {\"internalType\":\"string\",\"name\":\"desc\","
            + "\"type\":\"string\"},{\"internalType\":\"string\",\"name\":\"url\","
            + "\"type\":\"string\"}],\"name\":\"UpdateAsset\",\"outputs\":[],"
            + "\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},"
            + "{\"constant\":false,\"inputs\":[],"
            + "\"name\":\"getContractAddress\",\"outputs\":[{\"internalType\":\""
            + "address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,"
            + "\"stateMutability\":\"nonpayable\",\"type\":"
            + "\"function\"}]";
    String factoryCode = "608060405260405161001090610098565b604051809103906000f08015801561002c57"
            + "3d6000803e3d6000fd5b506000806101000a81548173fffffffffffffffffffffffffffffffffffff"
            ...
            + "061060283390190565b61054e806100b46000396000f3fe608060405234801561001057600080fd5b"
            + "50d3801561001d57600080fd5b50d2801561002a57600080fd5b506004361061005b5760003560e01"
            + "c806332a2c5d0146100605780633615673e146100aa578063f177bc7a14610117575b600080fd5b61"
            + "0068610273565b604051808273ffffffffffffffffffffffffffffffffffffffff1673fffffffffff"
            + "fffffffffffffffffffffffffffff16815260200191505060405180910390f35b6101016004803603"
            + "60808110156100c057600080fd5b81019080803590602001909291908035906020019092919080356"
            + "7ffffffffffffffff169060200190929190803560ff16906020019092919050505061029c565b6040"
            + "518082815260200191505060405180910390f35b6102716004803603606081101561012d57600080f"
            + "d5b81019080803590602001909291908035906020019064010000000081111561015457600080fd5b"
            + "82018360208201111561016657600080fd5b803590602001918460018302840111640100000000831"
            + "1171561018857600080fd5b91908080601f0160208091040260200160405190810160405280939291"
            + "90818152602001838380828437600081840152601f19601f820116905080830192505050505050509"
            + "192919290803590602001906401000000008111156101eb57600080fd5b8201836020820111156101"
            + "fd57600080fd5b8035906020019184600183028401116401000000008311171561021f57600080fd5"
            ...
            + "5090565b60008060009054906101000a900473ffffffffffffffffffffffffffffffffffffffff167"
            + "3ffffffffffffffffffffffffffffffffffffffff166329f00e59868686866040518563ffffffff16"
            ...
            + "1561034457600080fd5b505af1158015610358573d6000803e3d6000fd5b505050506040513d60208"
            + "1101561036e57600080fd5b81019080805190602001909291905050509050949350505050565b6000"
            ...
            + "0005b83811015610422578082015181840152602081019050610407565b5050505090509081019060"
            + "1f16801561044f5780820380516001836020036101000a031916815260200191505b5083810382528"
            + "4818151815260200191508051906020019080838360005b8381101561048857808201518184015260"
            + "208101905061046d565b50505050905090810190601f1680156104b55780820380516001836020036"
            + "101000a031916815260200191505b5095505050505050600060405180830381600087803b15801561"
            + "04d757600080fd5b505af11580156104eb573d6000803e3d6000fd5b5050505050505056fea264747"
            + "26f6e582068c6e59329c5b9e63f34ea5762d58db8649b294831356adfe323a04f3c96c25f64736f6c"
            ...
            + "1006b57600080fd5b810190808035906020019092919080359060200190929190803567ffffffffff"
            + "ffffff169060200190929190803560ff16906020019092919050505061021e565b604051808281526"
            ...
            + "d5b803590602001918460018302840111640100000000831117156101ca57600080fd5b9190808060"
            + "1f0160208091040260200160405190810160405280939291908181526020018383808284376000818"
            + "40152601f19601f82011690508083019250505050505050919291929050505061022f565b005b6000"
            ...
            + "76656c6f702e323032302e382e31332b636f6d6d69742e37633236393863300057";
    long value = 0;
    long fee = 100000000;
    long consumeUserResourcePercent = 0;
    // deploy contract
    ...
    Assert.assertEquals(rootRepository
            .getBalance(ByteArray.fromHexString(tmpAddress)), 10000000000L);

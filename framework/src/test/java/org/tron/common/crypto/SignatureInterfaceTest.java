...
public class SignatureInterfaceTest {
    ...
    private String SM2_privString = "128B2FA8BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263";
    private byte[] SM2_privateKey = Hex.decode(SM2_privString);

    private String SM2_pubString = "04d5548c7825cbb56150a3506cd57464af8a1ae0519dfaf3c58221dc810caf28dd921073768fe3d59ce54e79a49445cf73fed23086537027264d168946d479533e";
    ...
    public void testHash() {
        ...
        assertEquals("C5D2460186F7233C927E7DB2DCC703C0E500B653CA82273B7BFAD8045D85A470", Hex.toHexString(hash).toUpperCase());
    }

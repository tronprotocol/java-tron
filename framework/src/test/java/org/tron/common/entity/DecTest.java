...
public class DecTest {
  ...
  public void TestApproxRoot() {
    Stream.of(
        ...
        tc -> Assert.assertTrue(tc.s.sub(tc.k.approxRoot(tc.v)).abs().lte(Dec.smallestDec())));
    ...
    // iterations (100) causes the result at iteration 100 to be returned,
  ...
  public void TestArithmetic() {
    ...
    Stream.of(
            ...
            new Arithmetic(Dec.newDec(0), Dec.newDec(1), Dec.newDec(0), Dec.newDec(0),
                Dec.newDec(0),
                Dec.newDec(0), Dec.newDec(0), Dec.newDec(1), Dec.newDec(-1)),
            new Arithmetic(Dec.newDec(0), Dec.newDec(-1), Dec.newDec(0), Dec.newDec(0),
                Dec.newDec(0),
            ...
            new Arithmetic(Dec.newDec(-1), Dec.newDec(0), Dec.newDec(0), Dec.newDec(0),
                Dec.newDec(0),
                Dec.newDec(0), Dec.newDec(0), Dec.newDec(-1), Dec.newDec(-1)),
            new Arithmetic(Dec.newDec(1), Dec.newDec(1), Dec.newDec(1), Dec.newDec(1),
                Dec.newDec(1),

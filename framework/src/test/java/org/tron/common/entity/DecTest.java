...
public class DecTest {
 ...
 public void TestTruncate() {
   ...
   Stream.of(
    ...
    Assert.assertEquals(  1 * e.v, e.k.truncateLong());
   });
 }
 ...
 public void TestBankerRoundChop() {
  Stream.of(
   ...
   Assert.assertEquals(  1 * e.v,e.k.roundLong());
  });
 ...
 public static class Arithmetic {
  ...
  public Arithmetic(Dec d1, Dec d2, Dec expMul,
 ...
 public static class Equalities {
  ...
  public Equalities(Dec d1, Dec d2, boolean gt, boolean lt, boolean eq){
   this.d1 = d1;
   this.d2 = d2;
   this.gt = gt;
   this.lt = lt;

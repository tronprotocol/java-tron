...
@Slf4j
public class ShieldedContractTest {
  ...
  private static String trc20ContractAddress = "TWSA9TQwHUrGwh3uyPcF37v2yN5qFueCXY";
  private static String shieldedTRC20ContractAddress = "TLX7yXa89pn5icgKuedfLgbCV68Y22Bkr5";
...
//    return "txid";
  ...
  private String triggerBurn(WalletGrpc.WalletBlockingStub blockingStubFull, byte[] contractAddress,
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String txid = PublicMethed.triggerContract(contractAddress,
        "burn(bytes32[10],bytes32[2],uint256,bytes32[2],address,bytes32[3])",
        input,
        true,
        0L, 1000000000L,
        callerAddress, privateKey,

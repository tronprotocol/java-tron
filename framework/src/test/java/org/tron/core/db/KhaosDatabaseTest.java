...
public class KhaosDatabaseTest {
  ...
  public void testPushGetBlock() {
    ...
    } catch (UnLinkedBlockException | BadNumberBlockException | BlockNotInMainForkException e) {
  ...
  public void testGetBranch() {
    ...
    BlockCapsule block1OnforkA = new BlockCapsule(
        1, parentBlock.getBlockId(), 0, ByteString.EMPTY, ByteString.EMPTY);
    BlockCapsule block2OnforkA = new BlockCapsule(
        2, block1OnforkA.getBlockId(), 0, ByteString.EMPTY, ByteString.EMPTY);

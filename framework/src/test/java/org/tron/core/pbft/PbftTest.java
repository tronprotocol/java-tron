...
public class PbftTest {
  ...
  public void testPbftMessage() {
    ...
    srList.add(
        ByteString.copyFrom(ByteArray.fromHexString("41df309fef25b311e7895562bd9e11aab2a58816d2")));
    PbftMessage pbftSrMessage = PbftMessage
        .prePrepareBlockMsg(blockCapsule, 1, miner);
    System.out.println(pbftSrMessage);

    pbftSrMessage = PbftMessage
        .fullNodePrePrepareBlockMsg(blockCapsule, 1);
    System.out.println(pbftSrMessage);


    pbftSrMessage = PbftMessage
        .fullNodePrePrepareSRLMsg(blockCapsule, srList,1L);
    System.out.println(pbftSrMessage);

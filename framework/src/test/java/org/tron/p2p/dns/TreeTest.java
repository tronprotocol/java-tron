...
public class TreeTest {
  ...
  public void testTreeBuild() throws UnknownHostException {
    ...
    String enrBranch1 =
        "tree-branch:OX22LN2ZUGOPGIPGBUQH35KZU4,"
            + "XTGCXXQHPK3VUZPQHC6CGJDR3Q,"
            + "BQLJLB6P5CRXHI37BRVWBWWACY,"
            + "X4FURUK4SHXW3GVE6XBO3DFD5Y,"
            + "SIUYMSVBYYXCE6HVW5TSGOFKVQ,"
            + "2RKY3FUYIQBV4TFIDU7S42EIEU,"
            + "KSEEGRTUGR4GCCBQ4TYHAWDKME,"
            + "YGWDS6F6KLTFCC7T3AMAJHXI2A,"
            + "K4HMVDEHRKOGOFQZXBJ2PSVIMM,"
            + "NLLRMPWOTS6SP4D7YLCQA42IQQ,"
            + "BBDLEDOZYAX5CWM6GNAALRVUXY,"
            + "7NMT4ZISY5F4U6B6CQML2C526E,"
            + "NVDRYMFHIERJEVGW5TE7QEAS2A";
    String enrBranch2 =
        "tree-branch:5ELKMY4HVAV5CBY6KDMXWOFSN4,"
            + "7PHYT72EXSZJ6MT2IQ7VGUFQHI,"
            + "AM6BJFCERRNKBG4A5X3MORBDZU,"
            + "2WOYKPVTNYAY3KVDTDY4CEVOJM,"
            + "PW5BHSJMPEHVJKRF5QTRXQB4LU,"
            + "IS4YMOJGD4XPODBAMHZOUTIVMI,"
            + "NSEE5WE57FWG2EERXI5TBBD32E,"
            + "GOLZDJTTQ7V2MO2BG45O3Q22XI,"
            + "4VL7USGBWKW576WM4TX7XIXS4A,"
            + "GZQSPHDZYS7FXURGOQU3RIDUK4,"
            + "T7L645CJJKCQVQMUADDO44EGOM,"
            + "ATPMZZZB4RGYKC6K7QDFC22WIE,"
            + "57KNNYA4WOKVZAODRCFYK64MBA";
    String enrBranch3 =
        "tree-branch:BJF5S37KVATG2SYHO6M7APDCNU,"
            + "OUB3BDKUZQWXXFX5OSF5JCB6BA,"
            + "6JZEHDWM6WWQYIEYVZN5QVMUXA,"
            + "LXNNOBVTTZBPD3N5VTOCPVG7JE,"
            + "LMWLKDCBT2U3CGSHKR2PYJNV5I,"
            + "K2SSCP4ZIF7TQI4MRVLELFAQQE,"
            + "MKR7II3GYETKN7MSCUQOF6MBQ4,"
            + "FBJ5VFCV37SGUOEYA2SPGO3TLA,"
            + "6SHSDL7PJCJAER3OS53NYPNDFI,"
            + "KYU2OQJBU6AU3KJFCUSLOJWKVE,"
            + "3N6XKDWY3WTBOSBS22YPUAHCFQ,"
            + "IPEWOISXUGOL7ORZIOXBD24SPI,"
            + "PCGDGGVEQQQFL4U2FYRXVHVMUM";
    String enrBranch4 =
        "tree-branch:WHCXLEQB3467BFATRY5SMIV62M,"
            + "LAHEXJDXOPZSS2TDVXTJACCB6Q,"
            + "QR4HMFZU3STBJEXOZIXPDRQTGM,"
            + "JZUKVXBOLBPXCELWIE5G6E6UUU";
    ...
    */
    ...
    Assert.assertEquals(
        branchList.size() + enrList.size() + linkList.size(), tree.getEntries().size());

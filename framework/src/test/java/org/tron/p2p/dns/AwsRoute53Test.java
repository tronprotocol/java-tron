...
public class AwsRoute53Test {
  ...
  public void testChangeSort() {
    ...
    existing.put(
        ...
        new RecordSet(
            new String[] {
              "tree-root-v1:CjoKGlVKQU9JQlMyUFlZMjJYUU1WRlNXT1RZ"
                  + "SlhVEhpGRFhOM1NONjdOQTVES0E0SjJHT0s3QlZR"
                  + "SRgIEldBTE5aWHEyRkk5Ui1ubjdHQk9HdWJBRFVPa"
                  + "kZ2MWp5TjZiUHJtSWNTNks0ZE0wc1dKMUwzT2paWF"
                  + "RGei1KcldDenZZVHJId2RMSTlUczRPZ2Q4TXlJUnM"
            },
            AwsClient.rootTTL));
    existing.put(
    ...
    newRecords.put(
        "n",
        "tree-root-v1:CjoKGkZEWE4zU042N05BNURLQTRKMkdPSzdC"
            + "VlFJEhpGRFhOM1NONjdOQTVES0E0SjJHT0s3QlZR"
            + "SRgJElc5aDU4d1cyajUzdlBMeHNBSGN1cDMtV0ZEM"
            + "2lvZUk4SkJrZkdYSk93dmI0R0lHR01pQVAxRkJVVG"
            + "c4bHlORERleXJkck9uSDdSbUNUUnJRVGxqUm9UaHM");
    newRecords.put(
        "c7hrfpf3blgf3yr4dy5kx3smbe.n",
        "tree://AM5FCQLWIZX2QFPNJAP7VUERCCRNGRHWZG3YY"
            + "HIUV7BVDQ5FDPRT2@morenodes.example.org");
    newRecords.put(
        "jwxydbpxywg6fx3gmdibfa6cj4.n",
        "tree-branch:2XS2367YHAXJFGLZHVAWLQD4ZY,"
            + "H4FHT4B454P6UXFD7JCYQ5PWDY,"
            + "MHTDO6TMUBRIA2XWG5LUDACK24");
    newRecords.put(
        "2xs2367yhaxjfglzhvawlqd4zy.n",
        "nodes:-HW4QOFzoVLaFJnNhbgMoDXPnOvcdVuj7pDp"
            + "qRvh6BRDO68aVi5ZcjB3vzQRZH2IcLBGHzo8uUN3"
            + "snqmgTiE56CH3AMBgmlkgnY0iXNlY3AyNTZrMaEC"
            + "C2_24YYkYHEgdzxlSNKQEnHhuNAbNlMlWJxrJxbAFvA");
    newRecords.put(
        "h4fht4b454p6uxfd7jcyq5pwdy.n",
        "nodes:-HW4QAggRauloj2SDLtIHN1XBkvhFZ1vtf1ra"
            + "YQp9TBW2RD5EEawDzbtSmlXUfnaHcvwOizhVYLtr"
            + "7e6vw7NAf6mTuoCgmlkgnY0iXNlY3AyNTZrMaEC"
            + "jrXI8TLNXU0f8cthpAMxEshUyQlK-AM0PW2wfrnacNI");
    newRecords.put(
        "mhtdo6tmubria2xwg5ludack24.n",
        "nodes:-HW4QLAYqmrwllBEnzWWs7I5Ev2IAs7x_dZl"
            + "bYdRdMUx5EyKHDXp7AV5CkuPGUPdvbv1_Ms1CPf"
            + "hcGCvSElSosZmyoqAgmlkgnY0iXNlY3AyNTZrMa"
            + "ECriawHKWdDRk2xeZkrOXBQ0dfMFLHY4eENZwdufn1S1o");
    ...
    try {
      publish =
          new AwsClient(
              ...
              "random3",
              "us-east-1",
              new P2pConfig().getPublishConfig().getChangeThreshold());
    ...
    Change[] wantChanges =
        new Change[] {
          ...
          publish.newTXTChange(
              ...
              "c7hrfpf3blgf3yr4dy5kx3smbe.n",
              AwsClient.treeNodeTTL,
              "\"tree://AM5FCQLWIZX2QFPNJAP7VUERCCRNGRHWZG3"
                  + "YYHIUV7BVDQ5FDPRT2@morenodes.example.org\""),
          publish.newTXTChange(
              ChangeAction.CREATE,
              "h4fht4b454p6uxfd7jcyq5pwdy.n",
              AwsClient.treeNodeTTL,

...
public class PrivateUSDTContractTest {
  ...
  // Note: to run this function, should remove check of mint from the precompiled contracts
  @Test(enabled = true)
  public void testInsertCm() {

    byte[] contractAddress = WalletClient
        .decodeFromBase58Check("TY3iedr6q1nQLY3PG6t9Xif5tvjkHKHSdv");

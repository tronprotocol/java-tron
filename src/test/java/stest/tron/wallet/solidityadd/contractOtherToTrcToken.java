...
@Slf4j
public class contractOtherToTrcToken {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    String filePath = "./src/test/resources/soliditycode/contractOtherToTrcToken.sol";
  ...
  public void test02TriggerUint256ToTrctoken() {
...
//        assetAccountId.toByteArray(), 10L, dev001Address, dev001Key, blockingStubFull));
    ...
    Long receiveAssetBefore = PublicMethed.getAssetIssueValue(user001Address, assetAccountId,
        blockingStubFull);
    logger.info("before trigger, user001Address has AssetId "
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "uint256ToTrctoken(address,uint256,uint256)", param, false, callValue,
    ...
    Long receiveAssetAfter = PublicMethed.getAssetIssueValue(user001Address,
        assetAccountId, blockingStubFull);
    logger.info("after trigger, user001Address has AssetId "
    ...
    Assert.assertEquals(receiveAssetAfter - receiveAssetBefore,
        transferAssetBefore - transferAssetAfter);

  }

  @Test(enabled = true, description = "TransferToken with correct value, transfer to a contract")
  public void test03TriggerAddressToTrctoken() {
...
//        assetAccountId.toByteArray(), 10L, dev001Address, dev001Key, blockingStubFull));
    ...
    byte[] toAddress = new DataWord(user001Address).getData();
    byte[] tokenValue = new DataWord(1).getData();
    byte[] tokenId = new DataWord(Long.parseLong(assetAccountId.toStringUtf8())).getData();

    Long callValue = Long.valueOf(0);

    byte[] paramBytes = new byte[toAddress.length + tokenValue.length + tokenId.length];
    System.arraycopy(toAddress, 0, paramBytes, 0, toAddress.length);
    System.arraycopy(tokenValue, 0, paramBytes, toAddress.length, tokenValue.length);
  ...
  @Test(enabled = true, description = "TransferToken with correct value, transfer to a contract")
  public void test04TriggerBytes32ToTrctoken() {
...
//        assetAccountId.toByteArray(), 10L, dev001Address, dev001Key, blockingStubFull));
    ...
    logger.info("before trigger, user001Address has AssetId "
        + assetAccountId.toStringUtf8() + ", Count is " + receiveAssetBefore);
    DataWord tokenIdDataword = new DataWord(Long.parseLong(assetAccountId.toStringUtf8()));
    ...
    final String triggerTxid = PublicMethed.triggerContract(transferTokenContractAddress,
        "bytes32ToTrctoken(address,uint256,bytes32)", param, true, callValue,
        1000000000L, "0", 0, user001Address, user001Key,
        blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);

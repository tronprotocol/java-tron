...
public class contractOtherToTrcToken {
  ...
  public void test1Grammar002() {
    ...
    String para = "\"" + Base58.encode58Check(toAddress)
            + "\",\"" + tokenInt + "\",\"" + value + "\"";
    txid = PublicMethed.triggerContract(contractAddress,
            "uint256ToTrctoken(address,uint256,uint256)", para, false,
            0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull1);
    Optional<Protocol.TransactionInfo> infoById = null;
  ...
  public void test1Grammar003() {
    ...
    String para = "\"" + Base58.encode58Check(toAddress)
            + "\",\"" + adr + "\",\"" + value + "\"";
    txid = PublicMethed.triggerContract(contractAddress,
            "addressToTrctoken(address,address,uint256)", para, false,
            0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull1);
    Optional<Protocol.TransactionInfo> infoById = null;
  ...
  public void test1Grammar004() {
    ...
    String para = "\"" + Base58.encode58Check(toAddress)
            + "\",\"" + bytescode + "\",\"" + value + "\"";
    txid = PublicMethed.triggerContract(contractAddress,
            "bytesToTrctoken(address,bytes,uint256)", para, false,
            0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull1);
    Optional<Protocol.TransactionInfo> infoById = null;
  ...
  public void test1Grammar005() {
    ...
    String para = "\"" + Base58.encode58Check(toAddress)
            + "\",\"" + bytecode32 + "\",\"" + value + "\"";
    txid = PublicMethed.triggerContract(contractAddress,
            "uint256ToTrctoken(address,bytes32,uint256)", para, false,
            0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull1);
    Optional<Protocol.TransactionInfo> infoById = null;
  ...
  public void test1Grammar006() {
    ...
    String para = "\"" + Base58.encode58Check(toAddress)
            + "\",\"" + tokenInt + "\",\"" + value + "\"";
    txid = PublicMethed.triggerContract(contractAddress,
            "arrayToTrctoken(address,uint256,uint256)", para, false,
            0, maxFeeLimit, contractExcAddress, contractExcKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull1);
    Optional<Protocol.TransactionInfo> infoById = null;

...
@Slf4j
public class contractGetterContract {
  ...
  public void test1Grammar001() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/contractGetterContract.sol";
    String contractName = "getterContract";

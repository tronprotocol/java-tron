...
public class ContractTrcToken011 {
  ...
  @Test(enabled = true, description = "correct transferToken, deploy transferToken contract")
  ...
  @Test(enabled = true, description = "correct transferToken, deploy receive contract")
  ...
  @Test(enabled = true, description = "correct transferToken, trigger transfer contract to a contract")
  ...
  @Test(enabled = true, description = "correct transferToken, get contract token balance")

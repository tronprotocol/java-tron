...
public class ContractTrcToken012 {
  ...
  @Test(description = "correct transferToken, trigger transferToken contract to normal account")
  ...
  @Test(description = "correct transferToken, get account token balance")

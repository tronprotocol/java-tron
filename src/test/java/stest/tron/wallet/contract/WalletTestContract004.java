...
@Slf4j
public class WalletTestContract004 {
  ...
  public void beforeClass() {
    ...
    logger.info(Long.toString(PublicMethed.queryAccount(contract004Key,blockingStubFull)
        .getBalance()));
    Assert.assertTrue(PublicMethed.freezeBalanceGetCpu(contract004Address,1000000L,
  ...
  public void deployErc20TronToken() {
    ...
    byte[] contractAddress = PublicMethed.deployContract(contractName,abi,code,"",cpuLimit,
        storageLimit,maxFeeLimit,0L, contract004Key,contract004Address,blockingStubFull);

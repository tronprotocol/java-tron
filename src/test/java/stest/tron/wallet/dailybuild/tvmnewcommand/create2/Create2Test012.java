...
public class Create2Test012 {
  ...
  @Test(enabled = true, description = "Trigger create2 command with test bytecode and salt 1")
  ...
  @Test(enabled = true, description = "Trigger create2 command with test bytecode and salt 2")

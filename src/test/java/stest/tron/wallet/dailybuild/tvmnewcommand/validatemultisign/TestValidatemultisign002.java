...
public class TestValidatemultisign002 {
  ...
  public void test001DeployContract() {
    ...
    accountPermissionJson =
        "{\"owner_permission\":{\"type\":0,\"permission_name\":\"owner\",\"threshold\":2,\"keys\":["
            ...
            + "\",\"weight\":2}," + "{\"address\":\"" + PublicMethed.getAddressString(ownerKey)
            + "\",\"weight\":3}," + "{\"address\":\"" + PublicMethed.getAddressString(manager4Key)
            + "\",\"weight\":1}," + "{\"address\":\"" + PublicMethed.getAddressString(manager5Key)
            + "\",\"weight\":1}," + "]}]}";
  ...
  public void test002validatemultisign() {
    ...
    Transaction transaction = PublicMethedForMutiSign
        .sendcoinWithPermissionIdNotSign(fromAddress, 1L, ownerAddress, permissionId, ownerKey,
            blockingStubFull);

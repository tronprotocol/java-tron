...
public class TestValidatemultisign001 {
  ...
  public void test001DeployContract() {
    Assert.assertTrue(PublicMethed
        .sendcoin(dev001Address, 1000_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(PublicMethed.freezeBalanceForReceiver(fromAddress, 100_000_000L, 0, 0,
    ...
    String txid = PublicMethed
        .deployContractAndGetTransactionInfoById(contractName, abi, code, "", maxFeeLimit, 0L, 0,
            10000, "0", 0, null, dev001Key, dev001Address, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertTrue(PublicMethed
        .sendcoin(ownerAddress, needCoin + 2048000000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void test002validatemultisign() {
    ...
    Transaction transaction = PublicMethedForMutiSign
        .sendcoinGetTransaction(fromAddress, 1L, ownerAddress, ownerKey, blockingStubFull,
            ownerKeyString);
    ...
    List<Object> parameters = Arrays
        .asList(Wallet.encode58Check(ownerAddress), 0, "0x" + Hex.toHexString(hash), signatures);
    ...
    String TriggerTxid = PublicMethed
        .triggerContract(contractAddress, methodStr, input, false, 0, maxFeeLimit, dev001Address,
    ...
    parameters = Arrays
        .asList(Wallet.encode58Check(dev001Address), 0, "0x" + Hex.toHexString(hash), signatures);
    ...
    parameters = Arrays
        .asList(Wallet.encode58Check(fromAddress), 0, "0x" + Hex.toHexString(hash), signatures);
    input = PublicMethed.parametersString(parameters);
    ...
    parameters = Arrays
        .asList(Wallet.encode58Check(manager1Address), 0, "0x" + Hex.toHexString(hash), signatures);
    input = PublicMethed.parametersString(parameters);
    ...
    parameters = Arrays
        .asList("TVgXWwGWE9huXiE4FuzDuGnCPUowsbZ8VZ", 0, "0x" + Hex.toHexString(hash), signatures);
    input = PublicMethed.parametersString(parameters);
  ...
  public void test003validatemultisign() {
    ...
    List<Object> parameters = Arrays
        .asList(Wallet.encode58Check(ownerAddress), permissionId, "0x" + Hex.toHexString(hash),
            signatures);
    String input = PublicMethed.parametersString(parameters);
  ...
  public void test004validatemultisign() {
    ...
    Transaction transaction = PublicMethedForMutiSign
        .sendcoinWithPermissionIdNotSign(fromAddress, 1L, ownerAddress, 0, ownerKey,
            blockingStubFull);
    ...
    transaction = PublicMethedForMutiSign
        .sendcoinWithPermissionIdNotSign(fromAddress, 1L, ownerAddress, 0, ownerKey,
            blockingStubFull);
    ...
    transaction = PublicMethedForMutiSign
        .sendcoinWithPermissionIdNotSign(fromAddress, 1L, dev001Address, 0, dev001Key,
            blockingStubFull);
    transaction = TransactionUtils.setTimestamp(transaction);

...
public class ContractTestSendCoin001 {
  ...
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Return ret = PublicMethed.transferAssetForReturn(transferTokenContractAddress,
    ...
    Return ret1 = PublicMethed
        .sendcoinForReturn(transferTokenContractAddress, 1_000_000L, fromAddress,
            testKey002, blockingStubFull);
    ...
    String txid = PublicMethed.triggerContract(transferTokenContractAddress,
        "kill(address)", num, false,
        0, maxFeeLimit, dev001Address, dev001Key,
        blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);

    Long contractAssetCountBefore = PublicMethed.getAssetIssueValue(transferTokenContractAddress,
        assetAccountId, blockingStubFull);
    ...
    Assert.assertTrue(PublicMethed
        .sendcoin(transferTokenContractAddress, 1_000_000L, fromAddress,
            testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long contractAssetCountAfter = PublicMethed.getAssetIssueValue(transferTokenContractAddress,
        assetAccountId, blockingStubFull);
  ...
  public void testSendCoinAndTransferAssetContract002() {
    ...
    Return ret = PublicMethed
        .transferAssetForReturn(testContractAddress,
            assetAccountId.toByteArray(), 100L, dev001Address, dev001Key, blockingStubFull);
    ...
    Return ret1 = PublicMethed
        .sendcoinForReturn(testContractAddress, 1_000_000L,
            fromAddress,
            testKey002, blockingStubFull);
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, ret1.getCode());
    Assert.assertEquals("contract validate error : Cannot transfer trx to smartContract.",
    ...
    txid = PublicMethed.triggerContract(testContractAddress,
        "kill(address)", num, false,
        0, maxFeeLimit, dev001Address, dev001Key,
        blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Long contractAssetCountBefore = PublicMethed.getAssetIssueValue(testContractAddress,
        assetAccountId, blockingStubFull);
    ...
    Assert.assertTrue(PublicMethed.transferAsset(testContractAddress,
        assetAccountId.toByteArray(), 100L, dev001Address, dev001Key, blockingStubFull));

    Assert.assertTrue(PublicMethed
        .sendcoin(testContractAddress, 1_000_000L, fromAddress,
            testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long contractAssetCountAfter = PublicMethed.getAssetIssueValue(testContractAddress,
        assetAccountId, blockingStubFull);
  ...
  public void testSendCoinAndTransferAssetContract003() {
    ...
    String sendcoin = PublicMethed
        .sendcoinGetTransactionId(contractExcAddress, 1000000000L, fromAddress,
            testKey002,
            blockingStubFull);

    Assert.assertTrue(PublicMethed
        .sendcoin(contractExcAddress, 1000000000L, fromAddress,
            testKey002,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Return ret = PublicMethed
        .transferAssetForReturn(returnAddressBytes,
            assetAccountId.toByteArray(), 100L, dev001Address, dev001Key, blockingStubFull);
    ...
    Assert.assertTrue(PublicMethed.transferAsset(returnAddressBytes,
        assetAccountId.toByteArray(), 100L, dev001Address, dev001Key, blockingStubFull));

    Assert.assertTrue(PublicMethed
        .sendcoin(returnAddressBytes, 1_000_000L, fromAddress,
            testKey002, blockingStubFull));
    ...
    ret = PublicMethed
        .transferAssetForReturn(returnAddressBytes1,
            assetAccountId.toByteArray(), 100L, dev001Address, dev001Key, blockingStubFull);

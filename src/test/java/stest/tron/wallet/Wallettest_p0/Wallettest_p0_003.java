...
public class Wallettest_p0_003 {
    ...
    public void TestVoteWitness(){
        ...
        small_vote_map.put("27WvzgdLiUvNAStq2BCvA1LZisdD3fBX8jv", "2");
        HashMap<String,String> large_vote_map=new HashMap<String,String>();
        large_vote_map.put("27WvzgdLiUvNAStq2BCvA1LZisdD3fBX8jv", "3");

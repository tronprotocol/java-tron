...
public class WalletTest_p1_Account_001 {
    ...
    private final static  String solidityKey    = "86ff0c39337e9e97526c80af51f0e80411f5a1251473035f380f3671c1aa2b4b";
    ...
    public Account SolidityqueryAccount(String priKey,WalletSolidityGrpc.WalletSolidityBlockingStub blockingStubSolidity) {
    ...
    public Account grpcQueryAccountSolidity(byte[] address, WalletSolidityGrpc.WalletSolidityBlockingStub blockingStubSolidity) {
        ByteString addressBS = ByteString.copyFrom(address);
        Account request = Account.newBuilder().setAddress(addressBS).build();

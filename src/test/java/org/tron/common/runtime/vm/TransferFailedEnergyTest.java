...
contract EnergyOfTransferFailedTest {
    ...
    function testTransferTokenNonexistentTarget(address payable nonexistentTarget, trcToken tokenId)
    payable public {
        require(address(this).balance >= 10);
 ...
 */
  ...
  private TestCase[] testCasesAfterAllowTvmConstantinop = {
  ...
  private TestCase[] testCasesBeforeAllowTvmConstantinop = {
...
contract EnergyOfTransferFailedTest {
    ...
    function testTransferTokenNonexistentTarget(address nonexistentTarget, trcToken tokenId)
    payable public {
        require(address(this).balance >= 10);
        nonexistentTarget.transferToken(10, tokenId);
    }

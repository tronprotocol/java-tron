...
public class BandWidthRuntimeOutOfTimeTest {
  ...
  public void testSuccess() {
    try {
      ...
      TriggerSmartContract triggerContract = TvmTestUtils
          .createTriggerContract(contractAddress, "fibonacciNotify(uint256)", "500000", false, 0,
  ...
  private byte[] createContract()
    ...
    String abi = "[{\"constant\":false,\"inputs\":[{\"name\":\"number\",\"type\":\"uint256\"}],\""
        ...
        + "[{\"indexed\":false,\"name\":\"input\",\"type\":\"uint256\"},{\"indexed\":false,\""
        + "name\":\"result\",\"type\":\"uint256\"}],\"name\":\"Notify\",\"type\":\"event\"}]";

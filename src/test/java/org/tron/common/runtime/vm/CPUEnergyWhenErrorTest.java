...
@Slf4j
public class CPUEnergyWhenErrorTest {

  private Manager dbManager;
  private AnnotationConfigApplicationContext context;
  private DepositImpl deposit;
  private String dbPath = "output_CPUEnergyWhenErrorTest";
  ...
  // solidity for CPUEnergyWhenErrorTest
  ...
  @Test
  public void energyWhenErrorTest()
    ...
    TVMTestResult result = deployEnergyWhenErrorTestContract(value, feeLimit,
  ...
  public TVMTestResult deployEnergyWhenErrorTestContract(long value, long feeLimit,

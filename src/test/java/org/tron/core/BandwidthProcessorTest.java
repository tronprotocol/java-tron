...
public class BandwidthProcessorTest {
  ...
  public void testFree() throws Exception {
    ...
    Assert.assertEquals(122L + 8L, ownerCapsuleNew.getFreeNetUsage());
    ...
    Assert.assertEquals(122L + 8L, dbManager.getDynamicPropertiesStore().getPublicNetUsage());
    ...
    Assert.assertEquals(61L + 4L + 122 + 8L, ownerCapsuleNew.getFreeNetUsage());
    ...
    Assert.assertEquals(61L + 4L + 122L + 8L, dbManager.getDynamicPropertiesStore().getPublicNetUsage());
  ...
  public void testConsumeAssetAccount() throws Exception {
    ...
    Assert.assertEquals(122L + 8L, assetCapsuleNew.getNetUsage());
    ...
    Assert.assertEquals(122L + 8L, ownerCapsuleNew.getFreeAssetNetUsage(ASSET_NAME));
    Assert.assertEquals(0L, ret.getFee());
    ...
    Assert.assertEquals(61L + 4L + 122L + 8L, assetCapsuleNew.getNetUsage());
    ...
    Assert.assertEquals(61L + 4L + 122L + 8L, ownerCapsuleNew.getFreeAssetNetUsage(ASSET_NAME));
    Assert.assertEquals(0L, ret.getFee());
  ...
  public void testUsingFee() throws Exception {
    ...
    long transactionFee = (122L + 8L) * dbManager.getDynamicPropertiesStore().getTransactionFee();

...
public class BandwidthProcessorTest {
  ...
  public void testFree() throws Exception {
    ...
    Assert.assertEquals(122L + 7L, ownerCapsuleNew.getFreeNetUsage());
    ...
    Assert.assertEquals(122L + 7L, dbManager.getDynamicPropertiesStore().getPublicNetUsage());
    ...
    Assert.assertEquals(61L + 3 + 122 + 7L, ownerCapsuleNew.getFreeNetUsage());
    ...
    Assert.assertEquals(61L + 3L + 122L + 7L, dbManager.getDynamicPropertiesStore().getPublicNetUsage());
  ...
  public void testConsumeAssetAccount() throws Exception {
    ...
    Assert.assertEquals(122L + 7L, assetCapsuleNew.getNetUsage());
    ...
    Assert.assertEquals(122L + 7L, ownerCapsuleNew.getFreeAssetNetUsage(ASSET_NAME));
    Assert.assertEquals(0L, ret.getFee());
    ...
    Assert.assertEquals(61L + 3L + 122L + 7L, assetCapsuleNew.getNetUsage());
    ...
    Assert.assertEquals(61L + 3L + 122L + 7L, ownerCapsuleNew.getFreeAssetNetUsage(ASSET_NAME));
    Assert.assertEquals(0L, ret.getFee());
  ...
  public void testUsingFee() throws Exception {
    ...
    long transactionFee = (122L + 7L) * dbManager.getDynamicPropertiesStore().getTransactionFee();

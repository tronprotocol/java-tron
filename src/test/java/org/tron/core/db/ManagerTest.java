...
public class ManagerTest {
  ...
  public void init() {
    ...
    blockCapsule2 = new BlockCapsule(1, Sha256Hash.wrap(ByteString.copyFrom(ByteArray
        .fromHexString("0304f784e4e7bae517bcab94c3e0c9214fb4ac7ff9d7d5a937d1f40031f87b81"))), 0,
  ...
  public void updateWits() {
    ...
    dbManager.getWitnesses().forEach(witnessAddress -> {
      logger.info("witness address is {}", ByteArray.toHexString(witnessAddress.toByteArray()));
    });
    logger.info("------------");
  ...
  public void fork()
    ...
    BlockCapsule blockCapsule0 = createTestBlockCapsule(1533529947843L + 3000, num + 1,
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash().getByteString(),
        addressToProvateKeys);

    BlockCapsule blockCapsule1 = createTestBlockCapsule(1533529947843L + 3000, num + 1,
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash().getByteString(),
        addressToProvateKeys);
    ...
    BlockCapsule blockCapsule2 = createTestBlockCapsule(1533529947843L + 6000, num + 2,
  ...
  public void doNotSwitch()
    ...
    BlockCapsule blockCapsule1 = createTestBlockCapsule(1533529947843L + 3001, num + 1,
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash().getByteString(),
        addressToProvateKeys);
    ...
    BlockCapsule blockCapsule3 = createTestBlockCapsule(1533529947843L + 9000,
    ...
    Assert.assertEquals(blockCapsule3.getBlockId(),
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash());
    Assert.assertEquals(blockCapsule3.getBlockId(), dbManager.getBlockStore()
        .get(dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash().getBytes())
        .getBlockId());

    BlockCapsule blockCapsule4 = createTestBlockCapsule(1533529947843L + 12000,
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() + 1,
    ...
    Assert.assertEquals(blockCapsule4.getBlockId(),
        dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash());
    Assert.assertEquals(blockCapsule4.getBlockId(), dbManager.getBlockStore()
        .get(dbManager.getDynamicPropertiesStore().getLatestBlockHeaderHash().getBytes())
        .getBlockId());
  }
  ...
  public void testLastHeadBlockIsMaintenance()
    ...
    BlockCapsule blockCapsule = dbManager
        .generateBlock(witnessCapsule, 1533529947843L, privateKey, true, false);
  ...
  public void switchBack()
    ...
    dbManager.pushBlock(blockCapsule1);
    try {
      BlockCapsule blockCapsule2 = createTestBlockCapsuleError(1533529947843L + 6000, num + 2,
          blockCapsule1.getBlockId().getByteString(), addressToProvateKeys);
  ...
  private Map<ByteString, String> addTestWitnessAndAccount() {
    ...
    return IntStream.range(0, 2).mapToObj(i -> {
      ...
      AccountCapsule accountCapsule = new AccountCapsule(
          Account.newBuilder().setAddress(address).build());
  ...
  private BlockCapsule createTestBlockCapsule(long time, long number, ByteString hash,
    ...
    ByteString witnessAddress = witnessController
        .getScheduledWitness(witnessController.getSlotAtTime(time));

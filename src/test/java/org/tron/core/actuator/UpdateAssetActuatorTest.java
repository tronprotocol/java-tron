...
public class UpdateAssetActuatorTest {
  ...
  private Any getContract(String accountAddress, String description, String url, long newLimit,
      long newPublicLimit) {
    return Any.pack(Contract.UpdateAssetContract.newBuilder()
        ...
        .setNewLimit(newLimit).setNewPublicLimit(newPublicLimit).build());
  }
  ...
  private Contract.AssetIssueContract getAssetIssueContract() {
    ...
    return Contract.AssetIssueContract.newBuilder()
        ...
        .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY)
        .setId(String.valueOf(tokenId)).setTrxNum(100).setNum(10).setStartTime(nowTime)
        .setEndTime(nowTime + 24 * 3600 * 1000).setOrder(0)
        .setDescription(ByteString.copyFromUtf8("assetTest"))
        .setUrl(ByteString.copyFromUtf8("tron.test.com")).build();
  }
  ...
  public void successUpdateAssetBeforeSameTokenNameActive() {
    ...
    actuator = new UpdateAssetActuator(getContract(OWNER_ADDRESS, DESCRIPTION, URL, 500L, 8000L),
        dbManager);
    try {
      actuator.validate();
      ...
      AssetIssueCapsule assetIssueCapsuleV2 = dbManager.getAssetIssueV2Store()
          .get(ByteArray.fromString(String.valueOf(tokenId)));
      Assert.assertNotNull(assetIssueCapsuleV2);
      Assert.assertEquals(DESCRIPTION,
          assetIssueCapsuleV2.getInstance().getDescription().toStringUtf8());

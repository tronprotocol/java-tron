...
public class AccountPermissionUpdateActuatorTest {
  ...
  private Any getContract(ByteString address, List<Permission> permissions) {
    Contract.AccountPermissionUpdateContract contract =
        Contract.AccountPermissionUpdateContract.newBuilder()
            .setOwnerAddress(address)
            .clearPermissions()
  ...
  public void successUpdatePermissionKey() {
    ...
    updatePermissions.add(ownerPermission);
    updatePermissions.add(activePermission);

    AccountPermissionUpdateActuator actuator =
        new AccountPermissionUpdateActuator(getContract(address, updatePermissions), dbManager);
    ...
    try {
      ...
      Assert.assertEquals(updatePermissions, ownerPermissions);

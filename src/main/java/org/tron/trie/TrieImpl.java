...
import static org.tron.utils.ByteUtil.byteArrayToInt;
import static org.tron.utils.ByteUtil.isNullOrZeroArray;
import static org.tron.utils.ByteUtil.isSingleZero;
...
public class TrieImpl implements Trie<byte[]> {
  ...
  public final class Node {
    ...
    public boolean resolveCheck() {
      if (pbSerializ != null || parsedSerializ != null || hash == null) {
        return true;
      }

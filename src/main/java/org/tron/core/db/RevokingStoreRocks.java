...
public class RevokingStoreRocks implements RevokingDatabase {
  ...
  private static volatile RevokingStoreRocks instance;

  private RevokingStoreRocks() {
  }
  ...
  public static RevokingStoreRocks getInstance() {
    if (instance == null) {
      synchronized (RevokingStoreRocks.class) {
        if (instance == null) {
          instance = new RevokingStoreRocks();
        }
      }
    }
    return instance;
  ...
  @Override
  public ISession buildSession(boolean forceEnable) {
  ...
  public void add(IRevokingDB revokingDB) {
    dbs.add(((RevokingRocksDBWithCachingOldValue) revokingDB).getDbSource());
  ...
  private void addIfEmpty() {
    if (stack.isEmpty()) {
      stack.add(new RevokingStoreRocks.RevokingState());
    }
  }
  ...
  public static class Dialog implements ISession {
    ...
    public Dialog(RevokingStoreRocks.Dialog dialog) {
    ...
    void copy(RevokingStoreRocks.Dialog dialog) {
  ...
  static class RevokingState {
    ...
    Map<RevokingStoreRocks.RevokingTuple, byte[]> oldValues = new HashMap<>();
    Set<RevokingStoreRocks.RevokingTuple> newIds = new HashSet<>();
    Map<RevokingStoreRocks.RevokingTuple, byte[]> removed = new HashMap<>();
  }

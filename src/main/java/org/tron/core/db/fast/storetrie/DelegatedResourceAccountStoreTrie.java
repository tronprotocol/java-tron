...
@Slf4j
@Component
public class DelegatedResourceAccountStoreTrie extends
    TronStoreWithRevoking<BytesCapsule> implements DB<byte[], BytesCapsule> {
  ...
  @Autowired
  private DelegatedResourceAccountStoreTrie(@Value("delegatedResourceAccountTrie") String dbName) {
    super(dbName);
  }

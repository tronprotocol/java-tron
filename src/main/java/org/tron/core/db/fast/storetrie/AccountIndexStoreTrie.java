...
@Slf4j
@Component
public class AccountIndexStoreTrie extends TronStoreWithRevoking<BytesCapsule> implements
  ...
  @Autowired
  private AccountIndexStoreTrie(@Value("accountIndexTrie") String dbName) {
    super(dbName);
  }

  public byte[] getValue(byte[] key) {
    TrieImpl trie = trieService.getChildTrie(RLP.encodeString(ACCOUNT_INDEX_STORE_KEY), this);

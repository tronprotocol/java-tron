...
public class NodeDelegateImpl implements NodeDelegate {
  ...
  public void handleTransaction(TransactionCapsule trx) throws BadTransactionException {
    ...
    try {
      ...
      logger.info("Contract validate failed", e);
      throw new BadTransactionException();
    } catch (ContractExeException e) {
      logger.info("Contract execute failed", e);
      throw new BadTransactionException();
    } catch (ValidateSignatureException e) {
      logger.info("ValidateSignatureException");
      throw new BadTransactionException();
    } catch (ValidateBandwidthException e) {
      logger.info("ValidateBandwidthException");
    } catch (DupTransactionException e) {
      logger.info("dup trans");
    } catch (TaposException e) {
      logger.info("tapos error");
    } catch (TooBigTransactionException e) {
      logger.info("too big transaction");
    } catch (TransactionExpirationException e) {
      logger.info("expiration transaction");
    }
  }

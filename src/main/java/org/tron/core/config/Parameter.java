...
public interface Parameter {
  ...
  interface NodeConstant {
    ...
    int MAX_DEFERRED_TRANSACTION_PENDING = 500;
  }
  ...
  enum ChainParameters {
    ...
    MULTI_SIGN_FEE, // 1, 23
    DEFERRED_TRANSACTION_FEE, // 100_000, 24
    CANCEL_DEFERRED_TRANSACTION_FEE, // 50_000, 25
    MAX_DEFERRED_TRANSACTION_PROCESS_TIME, // 100, 26
//    ONE_DAY_NET_LIMIT,
//    MAX_FROZEN_TIME,
//    MIN_FROZEN_TIME,

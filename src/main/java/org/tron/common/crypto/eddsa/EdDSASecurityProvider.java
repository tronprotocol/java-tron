...
public class EdDSASecurityProvider extends Provider {
    ...
    protected void setup() {
        ...
        put("KeyFactory." + EdDSAKey.KEY_ALGORITHM, "org.tron.eddsa.KeyFactory");
        put("KeyPairGenerator." + EdDSAKey.KEY_ALGORITHM, "org.tron.eddsa.KeyPairGenerator");
        put("Signature." + EdDSAEngine.SIGNATURE_ALGORITHM, "org.tron.eddsa.EdDSAEngine");

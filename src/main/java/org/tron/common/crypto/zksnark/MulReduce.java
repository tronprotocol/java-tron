...
//            System.out.println("s1pi:" + s1pi.toString(16));
            s1pi = s1pi.multiply(bigIntegerLong);
//            System.out.println("mul_Result:" + s1pi.toString(16));
//            System.out.println("other add:" + bigIntegerToUnsignedLong(bigRet.resultValue, i).toString(16));
            BigInteger rpi = bigIntegerToUnsignedLong(bigRet.resultValue, i).add(s1pi);

//            System.out.println("add result:" + rpi.toString(16));
            bigRet.carryOut = bigIntegerToUnsignedLong(rpi, 1);
//            System.out.println("carryOut:" +bigRet.carryOut.toString(16));

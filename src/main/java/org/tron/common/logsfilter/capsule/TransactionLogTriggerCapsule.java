...
public class TransactionLogTriggerCapsule extends TriggerCapsule {
  ...
  public TransactionLogTriggerCapsule(TransactionCapsule trxCasule, BlockCapsule blockCapsule) {
    ...
    // program result
    if (Objects.nonNull(trxTrace) && Objects.nonNull(trxTrace.getRunner()) && Objects.nonNull(trxTrace.getRunner().getResult())) {
      ProgramResult programResult = trxTrace.getRunner().getResult();

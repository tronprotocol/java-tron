...
import org.tron.gossip.replication.BlackListReplicable;
import org.tron.gossip.replication.Replicable;
import org.tron.gossip.replication.WhiteListReplicable;
...
public class CrdtModule extends SimpleModule {
  ...
  public CrdtModule() {
    super("CrdtModule", new Version(0, 0, 0, "0.0.0", "org.tron.gossip", "gossip"));
  }

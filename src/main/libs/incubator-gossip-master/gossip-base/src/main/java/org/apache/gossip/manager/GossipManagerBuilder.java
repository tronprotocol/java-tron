...
public class GossipManagerBuilder {
    ...
    public static final class ManagerBuilder {
        ...
        public org.apache.gossip.manager.GossipManager build() {
            ...
            return new org.apache.gossip.manager.GossipManager(cluster, uri, id, properties, settings, gossipMembers,
                    listener, registry, messageHandler) {
            };
        }
    }

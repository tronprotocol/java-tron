...
public class ProposalUtil {
  ...
  public enum ProposalType {
                                  // current value, value range, id
    MAINTENANCE_TIME_INTERVAL(0), // 6 Hours, [3 * 27, 24 * 3600] s, 0
    ACCOUNT_UPGRADE_COST(1), // 9999 TRX, [0, 100000000000] TRX, 1
    CREATE_ACCOUNT_FEE(2), // 0.1 TRX, [0, 100000000000] TRX, 2
    TRANSACTION_FEE(3), // 10 Sun/Byte, [0, 100000000000] TRX, 3
    ASSET_ISSUE_FEE(4), // 1024 TRX, [0, 100000000000] TRX, 4
    WITNESS_PAY_PER_BLOCK(5), // 16 TRX, [0, 100000000000] TRX, 5
    WITNESS_STANDBY_ALLOWANCE(6), // 115200 TRX, [0, 100000000000] TRX, 6
    CREATE_NEW_ACCOUNT_FEE_IN_SYSTEM_CONTRACT(7), // 0 TRX, [0, 100000000000] TRX, 7
    CREATE_NEW_ACCOUNT_BANDWIDTH_RATE(8), // 1 Bandwith/Byte, [0, 100000000000000000] Bandwith/Byte, 8
    ALLOW_CREATION_OF_CONTRACTS(9), // 1, {0, 1}, 9
    REMOVE_THE_POWER_OF_THE_GR(10),  // 1, {0, 1}, 10
    ENERGY_FEE(11), // 10 Sun, [0, 100000000000] TRX, 11
    EXCHANGE_CREATE_FEE(12), // 1024 TRX, [0, 100000000000] TRX, 12
    MAX_CPU_TIME_OF_ONE_TX(13), // 50 ms, [0, 1000] ms, 13
    ALLOW_UPDATE_ACCOUNT_NAME(14), // 0, {0, 1}, 14
    ALLOW_SAME_TOKEN_NAME(15), // 1, {0, 1}, 15
    ALLOW_DELEGATE_RESOURCE(16), // 1, {0, 1}, 16
    TOTAL_ENERGY_LIMIT(17), // 50,000,000,000, [0, 100000000000000000], 17
    ALLOW_TVM_TRANSFER_TRC10(18), // 1, {0, 1}, 18
    TOTAL_CURRENT_ENERGY_LIMIT(19), // 50,000,000,000, [0, 100000000000000000], 19
    ALLOW_MULTI_SIGN(20), // 1, {0, 1}, 20
    ALLOW_ADAPTIVE_ENERGY(21), // 1, {0, 1}, 21
    UPDATE_ACCOUNT_PERMISSION_FEE(22), // 100 TRX, [0, 100000] TRX, 22
    MULTI_SIGN_FEE(23), // 1 TRX, [0, 100000] TRX, 23
    ALLOW_PROTO_FILTER_NUM(24), // 0, {0, 1}, 24
    ALLOW_ACCOUNT_STATE_ROOT(25), // 1, 1, 25
    ALLOW_TVM_CONSTANTINOPLE(26), // 1, {0, 1}, 26
    ALLOW_SHIELDED_TRANSACTION(27), // 0, {0, 1}, 27
    SHIELDED_TRANSACTION_FEE(28), // 10 TRX, [0, 10000] TRX, 28
    ADAPTIVE_RESOURCE_LIMIT_MULTIPLIER(29), // 1000, [1, 10000], 29
    ALLOW_CHANGE_DELEGATION(30), // 1, {0, 1}, 30
    WITNESS_127_PAY_PER_BLOCK(31), // 160 TRX, [0, 100000000000] TRX, 31
    ALLOW_TVM_SOLIDITY_059(32), // 1, {0, 1}, 32
    ADAPTIVE_RESOURCE_LIMIT_TARGET_RATIO(33), // 10, [1, 1000], 33
    SHIELDED_TRANSACTION_CREATE_ACCOUNT_FEE(34); // 1 TRX, [0, 10000], 34

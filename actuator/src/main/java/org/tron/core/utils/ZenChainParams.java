...
public class ZenChainParams {
  ...
  public static final int ZC_ENCPLAINTEXT_SIZE = (ZC_NOTEPLAINTEXT_LEADING + ZC_DIVERSIFIER_SIZE + ZC_V_SIZE + ZC_R_SIZE + ZC_MEMO_SIZE);
  public static final int ZC_OUTPLAINTEXT_SIZE = (ZC_JUBJUB_POINT_SIZE + ZC_JUBJUB_SCALAR_SIZE);
  public static final int ZC_ENCCIPHERTEXT_SIZE = (ZC_ENCPLAINTEXT_SIZE + NOTEENCRYPTION_AUTH_BYTES);
  public static final int ZC_OUTCIPHERTEXT_SIZE = (ZC_OUTPLAINTEXT_SIZE + NOTEENCRYPTION_AUTH_BYTES);
}

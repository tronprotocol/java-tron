...
public class VoteCrossActuator extends AbstractActuator {
  ...
  public boolean execute(Object object) throws ContractExeException {
    ...
    try {
      ...
      long voted = crossRevokingStore.getCrossVote(chainId, ByteArray.toHexString(address));
      Commons.adjustBalance(accountStore, address, -amount);
      crossRevokingStore.putCrossVote(chainId, ByteArray.toHexString(address), voted + amount);
  ...
  public boolean validate() throws ContractValidateException {
    ...
    long voteCountBefore = crossRevokingStore.getCrossVote(chainId, readableOwnerAddress);

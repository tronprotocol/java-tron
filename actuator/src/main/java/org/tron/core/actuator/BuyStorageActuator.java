...
public class BuyStorageActuator extends AbstractActuator {
  ...
  BuyStorageActuator(Any contract, AccountStore accountStore, DynamicPropertiesStore dynamicPropertiesStore) {
    super(contract, accountStore, dynamicPropertiesStore);
    storageMarket = new StorageMarket(accountStore, dynamicPropertiesStore);
  }
  ...
  public boolean validate() throws ContractValidateException {
    ...
    if (accountStore == null) {
      throw new ContractValidateException("No account store!");
    }
